    ...
    <div className="min-h-screen bg-[#010101]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="bg-[#0f0f0f] rounded-xl border border-white/5 p-8">
          <h2 className="text-xl font-bold text-white mb-6">Add Family Member</h2>
  ...
  return (
    <div className="bg-[#0f0f0f] rounded-xl border border-white/5 p-6">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <span className={`text-xs px-2 py-1 rounded ${roleColors[role as keyof typeof roleColors] || 'bg-gray-700 text-gray-300'} capitalize`}>
              {role}
            </span>
          </div>
        </div>
      ...
      <div className="space-y-2 mb-4">
        ...
        <div className="text-xs font-mono text-gray-400 break-all">{address}</div>
      </div>
